...
- 	View.cc
-	View.h
-	UML.PDF <- UML Diagram For Reading 
- 	UML.XML <- UML Diagram For Edit & Testing. Source: Draw.Io <- Editor Website 
...
1.2 		cd Juma_Imran_COMP_2404_101036672_A3_Files

1.3		Make  // Compile the Transmit file, you should see .exec file in folder

1.4		valgrind ./A3 // Compile the . exec file, you should see .exec file in 			folder


2.0	How To Launch & Run:


2.1 	Run the A3 - This can be done by typing ./A3 into your terminal.
