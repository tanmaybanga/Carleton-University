/**
 * Created by zachhauser on 2017-02-13.
 */
...
public class ShopperTestProgram {
    public static void main(String args[]) {
        ...
        // This Code Will Show Was Is Currently In the cart
        System.out.println("\nREMAINING CART CONTENTS: ");
        for (int i = 0; i < c.getNumItems(); i++) {
            System.out.println(" " + c.getCart()[i]);
        }

        // This Code Here Willl Show A summary Of Todays Shopping Trip Prices
        System.out.println("\nTOTAL FREEZER ITEM COST: $" + c.computeFreezerItemCost());
        System.out.println("\nTOTAL CART CONTENTS COST: $" + c.computeTotalCost());

        // This Code Here Will Show The Unpacking OF PErisbles, What Items Are Refrigerated, and What Items are Perishable
        System.out.println("\nUNPACKING PERISHABLES:");
        PerishableItem[] perishableItemsArray = c.removePerishables();
        for (PerishableItem perishableItem : perishableItemsArray) {
            System.out.println(perishableItem.toString());
        }

        // This Code Here Will Display Remaing Cart Contents
